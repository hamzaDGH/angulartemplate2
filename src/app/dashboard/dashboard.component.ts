...
export class DashboardComponent implements OnInit {
  ...
  onGetUsersByUserName(){
    ...
    console.log(this.currentKeyword);
      this.catService.getUsersByUserName(this.currentKeyword, this.currentPage, this.size).subscribe(data => {
  ...
  onGetUsers(){
    ...
    this.catService.getUsers(this.currentPage,this.size).subscribe(data=>{
      console.log("test01")
  ...
  onDeleteUser(u) {
    ...
    if (conf) {
      this.catService.deleteUserRessource(u._links.self.href).subscribe(data => {
        this.onGetUsersByUserName();
      }, err => {
        console.log(err);
      });
